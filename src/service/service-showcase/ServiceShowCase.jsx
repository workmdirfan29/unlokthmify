        ...
        <>
            ...
            <div className="grid mb-3.5 w-full h-auto grid-cols-1 gap-4 p-4 sm:grid-cols-2">
                {projects.map((project, index) => (
                    <div
                        key={index}
                        className="flex flex-col items-center p-4 overflow-hidden border-2 rounded-lg cursor-pointer bg-neutral-200"
                    >
                        {/* Image Container */}
                        ...
                        <div className="flex justify-start w-full mt-3">
                            <a
                                ...
                                className="flex items-center gap-3 px-4 py-2 text-white transition rounded-md hover:bg-black bg-neutral-900"
                            >
