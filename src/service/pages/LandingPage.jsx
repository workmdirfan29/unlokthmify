...
const LandingPage = () => {
    return (
        <div className="flex  justify-evenly container mx-auto flex-col-reverse md:flex-row items-center md:items-end px-4 md:px-8 pb-8 pt-4 md:pt-2 border-b my-4 border-slate-300  w-full min-h-[65vh] md:h-[40vh]">
            <div
                id="left-container"
